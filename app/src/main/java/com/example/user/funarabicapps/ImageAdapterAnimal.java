...
public class ImageAdapterAnimal extends BaseAdapter {
    ...
    private Integer[] mThumbIds = {
            R.drawable.definisikatanamakhaspertama, R.drawable.definisikatanamakhasdua,
            R.drawable.khasketiga, R.drawable.definisikatanamakhaskeempat,
            R.drawable.contohkhasmanusia, R.drawable.contohkhashaiwan,
            R.drawable.contohbendakhas, R.drawable.contohtempatkhas,
